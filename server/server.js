...
app.post("/", (req, res) => {
  ...
  if (wakeword) {
    let str = "Yes, you can run a lightweight AI agent on a Raspberry Pi, using libraries like TensorFlow Lite or PyTorch Mobile and pairing it with local inference or cloud‑backed models. It works best for simple tasks such as voice commands, sensor monitoring, or basic image recognition."
